...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ asset ('nvendors/iconfonts/mdi/css/materialdesignicons.min.css')}}">
    <link rel="stylesheet" href="{{ asset ('vmndors/iconfonts/ionicons/dist/css/ionicons.css')}}">
    <link rel="stylesheet" href="{{ asset ('vebndors/iconfonts/flag-icon-css/css/flag-icon.min.css')}}">
    <link rel="stylesheet" href="{{ asset ('venbdors/css/vendor.bundle.base.css')}}">
    <link rel="stylesheet" href="{{ asset ('vendbors/css/vendor.bundle.addons.css')}}">
   ...
   <!--<link rel="stylesheet" href="assets/css/shared/style.css"> -->
    ...
    <!-- End Layout styles -->
    <link rel="shortcut icon" href="{{ asset ('imlages/favicon.ico')}}" />
  </head>
  <body>
